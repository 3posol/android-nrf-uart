...
This application is deprecated and no longer supported. For new app development please use nRF Blinky or nRF Toolbox which can be found on https://github.com/3posol/android-nrf-uart. 
